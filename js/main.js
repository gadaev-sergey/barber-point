...
/* harmony import */ var _components_sg_accordion_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/sg-accordion.js */ "./src/js/components/sg-accordion.js");
/* harmony import */ var _components_sg_accordion_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_sg_accordion_js__WEBPACK_IMPORTED_MODULE_2__);
...
const modal = new graph_modal__WEBPACK_IMPORTED_MODULE_2__["default"](); // Реализация табов
...
// const swiper = new Swiper('.swiper-truth', {
//   slidesPerView: 1,
//   speed: 400,
//   pagination: {
...
/***/ "./src/js/components/sg-accordion.js":
/*!*******************************************!*\
  !*** ./src/js/components/sg-accordion.js ***!
  \*******************************************/
/***/ (() => {
...
const swiperTruth = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-truth', {
  slidesPerView: 1,
  speed: 400,
  pagination: {
    el: '.swiper-pagination'
...
const swiperGallery = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery__swiper', {
  slidesPerView: 'auto',
  spaceBetween: 16,
  speed: 400,
  pagination: {
...
const swiperPrice = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-price', {
  slidesPerView: 'auto',
  spaceBetween: 30,
  autoHeight: true,
  speed: 400,
...
function swiperFunc() {
  ...
  if (initNeeded && !isActive) {
    swiperWorker = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-worker', {
      slidesPerView: 'auto',
      spaceBetween: 7,
      autoHeight: true,
      speed: 400
  ...
  target.addEventListener('click', () => {
    if (!target.classList.contains('worker-btn--active')) {
      ...
      contents.forEach(content => {
        content.dataset.tabsContent === target.dataset.tabsTarget ? content.classList.add('card-worker--active') : content.classList.remove('card-worker--active');
      });
    }
  });
});
